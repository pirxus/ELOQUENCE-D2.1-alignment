"""Older training script for training the ECD/QFormer architecture with the T5 decoder"""
import sys
...
if __name__ == "__main__":
    ...
    tokenizer_source = tokenizer_target = tokenizer
    ...
    gen_config = GenerationConfig(
        bos_token_id=decoder.config.decoder_start_token_id,
