...
from models.s2t_qformer_marian import ApmoConfig, SpeechEncoderConvMarianEncoderDecoder
...
if __name__ == "__main__":
    ...
    if model_args.from_pretrained:
        ...
        model = SpeechEncoderConvMarianEncoderDecoder.from_pretrained(model_path, config, encoder, decoder_dummy)
        ...
        model = SpeechEncoderConvMarianEncoderDecoder(encoder=encoder, decoder=decoder, config=apmo_config)
