...
"""Bind custom models to the Auto* classes. Enable wrong import order because of this."""
...
class ModelArguments:
    ...
    pad_token_id: int = field(
        metadata={"help": ("The ID of the padding token in the tokenizer vocabulary.")},
    )
...
def main():
    ...
    proc_num_workers = data_args.preprocessing_num_workers
