...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/ebranchformer_english_medium_regularized_normalized_extended.out

EXPERIMENT="ebranchformer_english_medium_regularized_normalized_extended"
