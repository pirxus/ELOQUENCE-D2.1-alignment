...
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/english_model_medium_normalized_greedy_ctc.out

EXPERIMENT="english_model_medium_normalized_greedy_ctc"
