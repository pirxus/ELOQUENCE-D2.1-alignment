...
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/english_model_small_normalized_beam_ctc_trick.out

EXPERIMENT="english_model_small_normalized_beam_ctc_trick"
...
args=(
  ...
  --test_splits fleurs_test commonvoice_en_test
  ...
  --eos_space_trick_weight="0.5"
  --apply_eos_space_trick
)
