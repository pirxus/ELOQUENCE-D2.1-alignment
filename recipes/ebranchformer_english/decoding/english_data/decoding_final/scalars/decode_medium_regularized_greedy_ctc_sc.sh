...
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/english_model_medium_regularized_greedy_ctc_sc.out

EXPERIMENT="english_model_medium_regularized_greedy_ctc_sc"
