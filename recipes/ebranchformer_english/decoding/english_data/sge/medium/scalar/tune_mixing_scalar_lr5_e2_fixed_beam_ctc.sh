...
EXPERIMENT="english_mixing_scalar_lr5_e2_fixed_beam_ctc"
...
args=(
  ...
  --validation_slice="1"
  --test_splits voxpopuli_test tedlium3_test librispeech_test.clean librispeech_test.other commonvoice_en_test fleurs_test
  ...
  --from_pretrained="/mnt/matylda5/ipoloka/projects/huggingface_asr/experiments/english_mixing_scalar_lr5_e2/checkpoint-48/"
  --expect_2d_input
