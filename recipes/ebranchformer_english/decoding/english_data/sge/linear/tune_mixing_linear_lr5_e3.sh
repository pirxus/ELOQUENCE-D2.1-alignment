...
exec &> /mnt/matylda5/ipoloka/projects/LoCo-ASR/experiments/english_mixing_linear_lr5_e3.log
...
ssh -N -D 9013 pcspeech4 &
SSH_PID=$!

export http_proxy=socks5://localhost:9013

export https_proxy=socks5://localhost:9013
