...
#$ -l scratch=2
#$ -l gpu=1,gpu_ram=40G
#$ -o /mnt/matylda5/ipoloka/projects/LoCo-ASR/experiments/english_mixing_scalar_lr5_e3.o
#$ -e /mnt/matylda5/ipoloka/projects/LoCo-ASR/experiments/english_mixing_scalar_lr5_e3.e
...
EXPERIMENT="english_mixing_scalar_lr5_e3"
...
ssh -N -D 9003 pcspeech4 &
SSH_PID=$!

export http_proxy=socks5://localhost:9003

export https_proxy=socks5://localhost:9003
