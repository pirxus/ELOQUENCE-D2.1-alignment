...
EXPERIMENT="english_mixing_scalar_lr5_e4"
...
args=(
  ...
  --restart_from="/mnt/matylda5/ipoloka/projects/huggingface_asr/experiments/english_mixing_scalar_lr5_e4/checkpoint-429"
