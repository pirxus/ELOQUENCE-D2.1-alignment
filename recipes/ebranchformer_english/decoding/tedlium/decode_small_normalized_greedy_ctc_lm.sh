...
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/decoding_greedy_ctc_lm_tedlium_regularized_small.out

EXPERIMENT="decoding_greedy_ctc_lm_tedlium_regularized_small"
