...
#SBATCH --nodes=1
#SBATCH --gpus=1
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/decoding_beam_la_tuned_ctc_tedlium_regularized_small.out

EXPERIMENT="decoding_beam_la_tuned_ctc_tedlium_regularized_small"
...
args=(
  ...
  --expect_2d_input
  --config_overrides="decoder_average_logits=True;decoder_head_weights=[0.4685,0.4680]"
