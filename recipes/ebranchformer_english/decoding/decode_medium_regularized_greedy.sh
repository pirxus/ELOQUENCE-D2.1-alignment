...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/english_model_medium_regularized_greedy_decode.out

EXPERIMENT="english_model_medium_regularized_greedy_decode"
