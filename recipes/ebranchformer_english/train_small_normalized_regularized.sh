...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/ebranchformer_english_small_normalized_regularized.out

EXPERIMENT="ebranchformer_english_small_normalized_regularized"
