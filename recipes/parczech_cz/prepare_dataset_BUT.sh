...
#$ -e /mnt/matylda5/ipoloka/projects/huggingface_asr/parczech_cz.e
...
METADATA_DIR="/mnt/matylda5/iveselyk/KALDI_DATAPREPS/CZECH_ParCzech_3.0/kaldi_data/"
...
python src/dataset_builders/preprocess_dataset.py \
  ...
  --num_proc 16 \
  --splits parczech30_train_true-case-punct_300h parczech30_dev_true-case-punct parczech30_test_true-case-punct
