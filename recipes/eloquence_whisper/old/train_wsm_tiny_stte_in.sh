#!/bin/bash
#$ -N wsm_tiny_stte_cos_in
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=1
#$ -l scratch=2
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/chime/logs/wsm_tiny_stte_cos_in.o
#$ -e /mnt/matylda6/xsedla1h/projects/chime/logs/wsm_tiny_stte_cos_in.e
N_GPUS=1
EXPERIMENT="wsm_tiny_stte_cos_in"
