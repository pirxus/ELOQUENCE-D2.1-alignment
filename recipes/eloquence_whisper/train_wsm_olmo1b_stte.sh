...
#$ -l scratch=2
#$ -l gpu=4,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/chime/logs/wsm_olmo1b_stte.o
#$ -e /mnt/matylda6/xsedla1h/projects/chime/logs/wsm_olmo1b_stte.e
N_GPUS=4
N_GPUS=1
EXPERIMENT="wsm_olmo1b_stte"
EXPERIMENT="test" # FIX: bos_token_id is not used by OLMo..
