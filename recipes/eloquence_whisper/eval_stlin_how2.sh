...
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/eloquence/eval_slurp_wsm_olmo1b_stlin_w1000_how2.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/eloquence/eval_slurp_wsm_olmo1b_stlin_w1000_how2.e
N_GPUS=1
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/xsedla1h/projects/huggingface_asr/exp/wsm_olmo1b_stlin_w1000_how2/checkpoint-11000"
