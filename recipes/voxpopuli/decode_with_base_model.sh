...
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/ebranchformer_voxpopuli_small_decoding.out

EXPERIMENT="ebranchformer_voxpopuli_small_decoding"
...
args=(
  ...
  --from_pretrained="/mnt/proj1/open-28-58/lakoc/huggingface_asr/experiments/ebranchformer_voxpopuli_small_base/checkpoint-31344"
  --expect_2d_input
