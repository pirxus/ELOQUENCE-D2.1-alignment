#!/bin/bash
#$ -N whisper_sm_tinyllama_stlinear_lora_long
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=1
#$ -l scratch=5
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/chime/logs/whisper_sm_tinyllama_stlinear_lora_long.o
#$ -e /mnt/matylda6/xsedla1h/projects/chime/logs/whisper_sm_tinyllama_stlinear_lora_long.e
N_GPUS=2

EXPERIMENT="whisper_sm_tinyllama_stlinear_lora_long"
