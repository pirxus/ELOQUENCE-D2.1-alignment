#!/bin/bash
#$ -N whisper_sm_llama2_chat_stlinear
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=1
#$ -l scratch=2
#$ -l gpu=2,gpu_ram=40G
#$ -o /mnt/matylda6/xsedla1h/projects/chime/logs/whisper_sm_llama2_chat_stlinear.o
#$ -e /mnt/matylda6/xsedla1h/projects/chime/logs/whisper_sm_llama2_chat_stlinear.e
N_GPUS=2

EXPERIMENT="whisper_sm_llama2_chat_stlinear"
...
args=(
  ...
  --prompt_prefix='USER: '
  --prompt_suffix=' Transcribe this speech. ASSISTANT: '
