#!/bin/bash
#$ -N wsm_tiny_ste_cos_pre
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=1
#$ -l scratch=2
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/chime/logs/wsm_tiny_ste_cos_pre.o
#$ -e /mnt/matylda6/xsedla1h/projects/chime/logs/wsm_tiny_ste_cos_pre.e
N_GPUS=2
EXPERIMENT="wsm_tiny_ste_cos_pre"
