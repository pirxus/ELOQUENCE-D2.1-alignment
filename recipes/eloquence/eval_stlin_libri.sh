#!/bin/bash
#$ -N eval_slurp_wsm_olmo1b_stlin_w1000_libri
#$ -q short.q@supergpu15
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=1,scratch=1
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_slurp_wsm_olmo1b_stlin_w1000_libri.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_slurp_wsm_olmo1b_stlin_w1000_libri.e
N_GPUS=1
EXPERIMENT="eval_slurp_wsm_olmo1b_stlin_w1000_libri"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/wsm_olmo1b_stlin_w1000_libri/checkpoint-24000"
