#!/bin/bash
#$ -N wsm_olmo1b_stte_w2000_libri_how2_cont
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=1,scratch=1
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/eloquence/wsm_olmo1b_stte_w2000_libri_how2_cont.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/eloquence/wsm_olmo1b_stte_w2000_libri_how2_cont.e
N_GPUS=2
EXPERIMENT="wsm_olmo1b_stte_w2000_libri_how2_cont"
...
args=(
  ...
  --test_splits val how2_dev5 librispeech_test.clean librispeech_test.other
