#!/bin/bash
#$ -N eval_wlml_stte_olmo1b_context_no_trunc_2
#$ -q all.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_wlml_stte_olmo1b_context_no_trunc_2.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_wlml_stte_olmo1b_context_no_trunc_2.e
N_GPUS=1
EXPERIMENT="eval_wlml_stte_olmo1b_context_no_trunc_2"
...
args=(
  ...
  --per_device_eval_batch_size="8" #"8" # 24
  ...
  #--from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/wlml_stte_olmo1b_context/checkpoint-22000"
  --from_pretrained="/mnt/matylda6/isedlacek/projects/huggingface_asr/exp/wlml_stte_olmo1b_context_turns/checkpoint-50000"
