...
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/wsm_olmo1b_stlin_w1000_libri.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/wsm_olmo1b_stlin_w1000_libri.e
N_GPUS=2
