#!/bin/bash
#$ -N eval_bolaji_wavlm_ft
#$ -q all.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5,scratch=0.5
#$ -l gpu=1,gpu_ram=40G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_bolaji_wavlm_ft.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_bolaji_wavlm_ft.e
N_GPUS=1
EXPERIMENT="eval_bolaji_wavlm_ft"
...
#DATASETS="${RECIPE_DIR}/datasets_fleurs.json"
...
args=(
  ...
  --per_device_train_batch_size="8" # 20
  ...
  #--from_pretrained="/mnt/matylda5/iyusuf/exps/eloquence/huggingface_asr/bsc_exp/wll_olmo7b_instruct_stte_mix_libri_synth/checkpoint-10000"
  --from_pretrained="/mnt/matylda5/iyusuf/exps/eloquence/huggingface_asr/bsc_exp/wll_olmo7b_instruct_stte_mix_libri_synth_train_enc/checkpoint-15000"
