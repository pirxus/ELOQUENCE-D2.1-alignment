...
#$ -l matylda6=1
#$ -l gpu=2,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/wsm_olmo1b_stlin_w1000_how2.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/wsm_olmo1b_stlin_w1000_how2.e
N_GPUS=2
