#!/bin/bash
#$ -N eval_slurp_wsm_olmo1b_stte_w2000_how2
#$ -q short.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=1
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_slurp_wsm_olmo1b_stte_w2000_how2.o
#$ -e /mnt/matylda6/isedlacek/projects/job_logs/eloquence/eval_slurp_wsm_olmo1b_stte_w2000_how2.e
N_GPUS=1
EXPERIMENT="eval_slurp_wsm_olmo1b_stte_w2000_how2"
