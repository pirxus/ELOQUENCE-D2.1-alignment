#!/bin/bash
#$ -N qf_ebr_t5_6l_256d_100q.o
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5
#$ -l ssd=1,ssd_free=200G
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/qformer_tests/qf_ebr_t5_6l_256d_100q.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/qformer_tests/qf_ebr_t5_6l_256d_100q.e
#

EXPERIMENT="qf_ebr_t5_6l_256d_100q"
