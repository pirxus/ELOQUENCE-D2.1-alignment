#!/bin/bash
#$ -N eval_qkv_no_ft_new
#$ -q all.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5
#$ -l ssd=1,ssd_free=100G
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/qformer_new/eval_qkv_no_ft_new.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/qformer_new/eval_qkv_no_ft_new.e
#
#
## used to train a joint SLT model with a S2T encoder and MarianMT decoder

EXPERIMENT="eval_qkv_no_ft_new"
