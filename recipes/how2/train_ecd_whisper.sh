#!/bin/bash
#$ -N ecd_whisper_ste_6l_opus_2_cont.o
#$ -q long.q@supergpu18
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5
#$ -l ssd=1,ssd_free=100G
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/opus/ecd_whisper_ste_6l_opus_2_cont.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/opus/ecd_whisper_ste_6l_opus_2_cont.e
#
## used to train a joint SLT model with a S2T encoder and MarianMT decoder

EXPERIMENT="ecd_whisper_ste_6l_opus_2_cont"
...
args=(
  ...
  --restart_from="/mnt/matylda6/xsedla1h/projects/huggingface_asr/exp/ecd_whisper_ste_6l_opus_2/checkpoint-74536"
