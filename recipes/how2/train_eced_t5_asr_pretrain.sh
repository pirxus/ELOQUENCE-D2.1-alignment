...
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/low_resource/t5_asr_pretrain.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/low_resource/t5_asr_pretrain.e
#
## used to train a joint SLT model with a S2T encoder and MarianMT decoder

EXPERIMENT="t5_asr_pretrain"
...
args=(
  ...
  --eval_delay="15.0"
  #--restart_from="/mnt/matylda6/xsedla1h/projects/huggingface_asr/exp/pretrained_51h_2e4_500/checkpoint-12744"
  ...
  #--how2_low_resource_split_file="/mnt/scratch/tmp/kesiraju/low_resource_splits/how2/train_51h.uttids"
  ...
  #--from_pretrained="/mnt/matylda6/xsedla1h/projects/huggingface_asr/exp/asr_pretrain_marian/checkpoint-55469"
  ...
  --base_decoder_model="/mnt/matylda6/xsedla1h/projects/huggingface_asr/exp/t5_english_pre/checkpoint-50744"
...
python src/trainers/alignment/train_eced.py "${args[@]}"
