#!/bin/bash
#$ -N ebr_marian_slt_baseline
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5
#$ -l ssd=1,ssd_free=100G
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/qformer/ebr_marian_slt_baseline.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/qformer/ebr_marian_slt_baseline.e
#
#
## used to train an e2e ST model with a S2T/EBR encoder and MarianMT decoder

EXPERIMENT="ebr_marian_slt_baseline"
