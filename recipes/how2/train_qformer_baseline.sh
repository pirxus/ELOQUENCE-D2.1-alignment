#!/bin/bash
#$ -N qf_mt_6l_60_avg_mm
#$ -q long.q@supergpu*
#$ -l ram_free=40G,mem_free=40G
#$ -l matylda6=0.5
#$ -l ssd=1,ssd_free=200G
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/qformer/qf_mt_6l_60_avg_mm.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/qformer/qf_mt_6l_60_avg_mm.e
#

EXPERIMENT="qf_mt_6l_60_avg_mm"
