...
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/qformer_last/eval_bridge_mt0.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/qformer_last/eval_bridge_mt0.e
#
## used to train a joint SLT model with a S2T encoder and MarianMT decoder

EXPERIMENT="eval_bridge_mt0"
...
args=(
  ...
  --from_pretrained="/mnt/matylda6/xsedla1h/projects/huggingface_asr/exp/arch_2_test_mt0_2l_512/checkpoint-32619"
