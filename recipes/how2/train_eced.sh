...
#$ -l gpu=1,gpu_ram=20G
#$ -o /mnt/matylda6/xsedla1h/projects/job_logs/low_resource/base_eced.o
#$ -e /mnt/matylda6/xsedla1h/projects/job_logs/low_resource/base_eced.e
#
## used to train a joint SLT model with a S2T encoder and MarianMT decoder

EXPERIMENT="base_eced"
...
args=(
  ...
  --replace_aligned_decoder # used to init the mt decoder with the one pretrained for asr
