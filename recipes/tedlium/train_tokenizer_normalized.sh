...
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/ebranchformer_tedlium_small_normalized_tokenizer.out

EXPERIMENT="ebranchformer_tedlium_small_normalized_tokenizer"
