...
#SBATCH --nodes=1
#SBATCH --gpus=4
#SBATCH --output=/mnt/proj1/open-28-58/lakoc/huggingface_asr/outputs/ebranchformer_tedlium_small_normalized_v2_decoding.out

EXPERIMENT="ebranchformer_tedlium_small_normalized_v2_decoding"
...
args=(
  ...
  --from_pretrained="/mnt/proj1/open-28-58/lakoc/huggingface_asr/experiments/ebranchformer_tedlium_small_normalized_v2/checkpoint-110040"
  --expect_2d_input
